...
The main objective of this project is to create POC fast. Do not worry about getting model with very high performance.  
...
Some suggestions and istructions:
I suggest using a small subsample to speed up model training. 
Usually xgb beats RF in performance and is much faster to train.
